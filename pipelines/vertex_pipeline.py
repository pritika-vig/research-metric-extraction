    ...
    def build_config(self) -> ExtractionConfig:
        return ExtractionConfig(
            ...
            fields=[
                ...
                ExtractionFieldSpec(
                    "Key Findings",
                    "Summarize the main results or conclusions of the study",
                ),
                ExtractionFieldSpec(
                    "Patient/Public Engagement (Y/N)",
                    (
                        "Does the study report any involvement of patients or the public? "
                        " This includes participation, feedback, consultation, or co-design."
                    ),
                ),
                ExtractionFieldSpec(
                    "Type of Engagement (Montreal Model continuum)",
                    (
                        "Categorize engagement based on the Montreal Model: "
                        "Information, Consultation, Collaboration, or Partnership."
                    ),
                ),
                ExtractionFieldSpec(
                ...
                ExtractionFieldSpec(
                    "Type of Evaluation",
                    (
                        "What type of method or framework was used to evaluate the impact of engagement "
                        " (e.g., metrics, qualitative feedback, evaluation framework)?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Impact of Engagement",
                    (
                        "Describe any outcomes or changes attributed to patient/public "
                        "engagement (e.g., design changes, improved recruitment, insights)."
                    ),
                ),
                ExtractionFieldSpec(
                ...
                ExtractionFieldSpec(
                    ...
                    (
                        "Did engagement lead to reported changes in health "
                        "care delivery, systems design, or institutional practice?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Persuasive Design Techniques",
                    (
                        "Were behavior-change strategies or persuasive "
                        "technologies mentioned (e.g., nudges, gamification, reminders)?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Assess Impact",
                ...
                ExtractionFieldSpec(
                    "Information",
                    (
                        "Was information provided to patients/public about the study, "
                        "without involving them in decision-making?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Consultation",
                    (
                        "Was patient or public input sought (e.g., through interviews, surveys, focus groups), "
                        "without involving them in decision-making?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Collaboration",
                    (
                        "Was there shared decision-making or co-design "
                        "between researchers and participants in any phase of the study?"
                    ),
                ),
                ExtractionFieldSpec(
                    "Partnership",
